...
``` html
<script type="module">
    import pkg from '//cdn.pika.dev/caterpillar-browser/^6.2.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//unpkg.com/caterpillar-browser@^6.2.0'
</script>
```
...
``` html
<script type="module">
    import pkg from '//dev.jspm.io/caterpillar-browser@6.2.0'
</script>
```
